...
#при неправильном фишера начинает сначала
while True:
    ...
    while True:
        ...
        print("дисперсия {}однородна, с вероятностью = {:.2}"
    ...
    print("уравнение  {}адекватно оригиналу, с вероятностью = {:.2f}\n"
